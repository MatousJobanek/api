...
[id="{anchor_prefix}-github-com-codeready-toolchain-api-api-v1alpha1-accountverifierreason"]
==== AccountVerifierReason
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-codeready-toolchain-api-api-v1alpha1-accountverifierresponse[$$AccountVerifierResponse$$]
****
...
[id="{anchor_prefix}-github-com-codeready-toolchain-api-api-v1alpha1-accountverifierresult"]
==== AccountVerifierResult
...
| *`verifiedTimestampExpiryDays`* __integer__ | VerifiedTimestampExpiryDays controls for how many days the verified timestamp at UserSignup stays valid + |  | Minimum: 0 +
Optional: \{} +
